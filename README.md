...
This package is an ROS2 driver for the L3Cam device manufactured by [Beamagine](https://beamagine.com/). The driver relies on the library `libL3Cam 0.1.14` provided by Beamagine as part of the [L3Cam SDK](https://github.com/beamaginelidar/libl3cam.git). For more info on the L3Cam check the [L3Cam User Manual](https://github.com/beamaginelidar/libl3cam/blob/main/L3CAM%20User%20Manual.pdf).
...
Download the package from Beamagine's [L3Cam SDK 0.1.14 release](https://github.com/beamaginelidar/libl3cam/releases/tag/0.1.14R) repository and install the required package depending on your hardware architecture:
